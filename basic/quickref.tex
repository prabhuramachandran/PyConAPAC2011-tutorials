...
\textbf{FIXME:} fix header and date?
\end{center}
\vspace{-2ex}
...
{\ex \typ{savefig}} {\ex \typ{figure}}\\
{\ex \typ{axes}} {\ex \typ{outline}}\\
{\ex \typ{title}} {\ex \typ{xlabel, ylabel, zlabel}}\\
{\ex \typ{colorbar}} {\ex \typ{scalarbar}} {\ex \typ{vectorbar}}\\
{\ex \typ{show}} 
